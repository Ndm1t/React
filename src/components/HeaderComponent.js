...
class Header extends Component{
    ...
    handleLogin(event){
        this.toggleModal()
        alert("Username: " + this.username.value + " Password: " + this.password.value + " Remember: " + this.rem.checked)
                    ...
                    <Form onSubmit={this.handleLogin}>
                        ...
                        <FormGroup check>
                                <Label check>
                                    ...
                                    innerRef={(input) => this.rem = input} />
                                    Remember me
                                </Label>
                            </FormGroup>
                        <Button type="submit" value="submit" className="primary">Log In</Button>
                    </Form>
                </ModalBody>
            </Modal>
            </>
